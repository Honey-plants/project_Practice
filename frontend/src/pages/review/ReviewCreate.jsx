      ...
      {loadingVerify && (
        <div className={styles.loadingOverlay}>
          <div className={styles.loadingBox}>
            ...
            <p className={styles.loadingText}>Authenticating receipt...</p>
          </div>
        </div>
      )}
      <h2 className={styles.reviewCreateTitle}>Review registration</h2>
      ...
      {receiptId && menuConfirmed && (
        <div className={styles.stepSection}>
          ...
          <div className={styles.reviewForm}>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Contents</label>
              <textarea
                value={content}
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Add Image (Max 3)</label>
              <input
                ref={imageInputRef}
                type="file"
                accept="image/*"
            ...
            <button onClick={create} disabled={loadingCreate} className={styles.btnSubmit}>
              {loadingCreate ? "Creating..." : "Create Review"}
            </button>
          </div>
        </div>
      )}
